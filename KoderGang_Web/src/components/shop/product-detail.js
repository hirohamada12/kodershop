...
import {Button, Container, Nav, NavItem, NavLink, Row, TabContent, TabPane} from 'reactstrap';
...
class ProductDetail extends Component {
    ...
    render() {
        const Productedit = this.state.AllProduct.find(item => item.id === this.state.ProductId);
        return (
            <div>
                {Productedit ?
                            ...
                            <Container>
                                ...
                                <div className="product-content-bottom">
                                    ...
                                    <TabContent activeTab={this.state.activeTab}>
                                        ...
                                        <TabPane tabId="2">
                                            <div className="product-reviews">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        <label className="mb-0">Đánh gía *</label>
                                                        <ul class="rating list-unstyled">
                                                            <li><i class="fa fa-star"/></li>
                                                            <li><i class="fa fa-star"/></li>
                                                            <li><i class="fa fa-star"/></li>
                                                            <li><i class="fa fa-star-half-o"/></li>
                                        ...
                                        <TabPane tabId="3">
                                            <p>The Crochet-Shoulder Chevron Sweatshirt ipsum dolor sit amet, consectetur
                                                adipisicing elit. Tenetur, libero, ratione. Tenetur dolor vitae
                                                voluptatem, earum nam, voluptas culpa ex vel et aliquid aperiam pariatur
                                                ad hic commodi, dicta tempora.</p>
                                            <p>Wearing a sweatshirt in public doesn’t mean you can’t look put-together
                                                doing it. The Crochet-Shoulder Chevron Sweatshirt from Knox Rose is
                                                slightly more tailored for a pullover, though it still gives you a loose
                                                fit that remains comfortable and flexible as you move. The textured
                                                fabric is enhanced with crochet sleeve details. Throw this long-sleeve
                                                sweatshirt over a pair of jeans and you’re ready to go. </p>
                                        </TabPane>
                                    </TabContent>
