                                ...
                                <div className="summary entry-summary">
                                    ...
                                    <FormGroup className="edit-icon">
                                        <Input type="text" className="form-control price" placeholder="Product Price"
                                               defaultValue={`${product.salePrice} đ`}/>
                                    </FormGroup>
                                    <FormGroup className="edit-icon">
                                        <Input type="textarea" className="form-control" rows="3"
                                               placeholder="Product Description" defaultValue={product.description}/>
                                    </FormGroup>
                                    ...
                                    <input type="text" className="form-control" placeholder="Total Product"
                                    ...
                                    <Link to="/admin/Product" class="btn btn-danger mb-2"> Cancel </Link>
                                </div>
                            </div>
                        </div>
                    </Row>
