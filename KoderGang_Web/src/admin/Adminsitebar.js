                    ...
                    <Col lg={3}>
                        <div className="woocommerce-MyAccount-navigation">
                            <Nav className="flex-column">
                                <NavItem >
                                    <Link className={`${this.state.Prof_act === true ? 'active' : '' } adminprofile nav-link admin-nav`} to="/admin/Profile" > <i className="fa fa-user-o"></i> Thông Tin</Link>
                                </NavItem>
                                <NavItem >
                                    <Link className={`${this.state.Coll_act === true ? 'active' : '' } collaboration nav-link admin-nav`} to="/admin/Collaboration"  > <i className="fa fa-map-marker"></i> Nhân Viên</Link>
                                </NavItem>
                                {/*<NavItem >*/}
                                {/*    <Link className={`${this.state.Sett_act === true ? 'active' : '' } account nav-link admin-nav`} to="/admin/Settings" > <i className="fa fa-cogs"></i> Account Settings</Link>*/}
                                {/*</NavItem>*/}
                            </Nav>
                        </div>
                    </Col>
