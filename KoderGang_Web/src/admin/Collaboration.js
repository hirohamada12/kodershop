...
import MyCollaboration from '../common/MyCollaboration';
                                ...
                                <Col lg={12}>
                                    <div className="woocommerce-Address">
                                        <div className="woocommerce-Address-title">
                                            ...
                                            <a class="add-user btn btn-primary ml-auto" onClick={this.toggle} href="#">Thêm
                                                người dùng</a>
                                        </div>
                                                    ...
                                                    {collabroations.length > 0 ?
                                                        ...
                                                        {collabroations.map((collabro) =>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img
                                                                        src={require(`../assets/images/${collabro.image}`)}
                                                                        alt="profile"
                                                                ...
                                                                <td>
                                                                    <a className="delete-button"
                                                                       onClick={() => this.onDeleteCollaboration(collabro)}
                                                                       href="#"> Xóa <i
                                                                        className="fa fa-trash-o pl-2"></i></a>
                                                                </td>
                                                            </tr>
                                                        )}
                                                        </tbody>
                                    ...
                                    <Modal isOpen={this.state.modal} toggle={this.toggle}
                                        ...
                                        <form onSubmit={this.AddUserSubmit.bind(this)}>
                                            ...
                                            <ModalFooter className="justify-content-start pt-4">
                                                <Button type="submit"
                                                        className="action-button btn-primary">Submit</Button>
                                                <Button className="action-button no" href="#"
                                    ...
                                    <Modal isOpen={this.state.modal1} toggle={this.toggle1}
                                        ...
                                        <ModalFooter className="justify-content-center pt-4">
                                            <Link to={'#'} className="action-button"
                                                  onClick={(res) => this.onDeleteCollaborations(res)}>Yes</Link>
                                            <Link to={'#'} className="action-button no" onClick={this.toggle1}>No</Link>
                                        </ModalFooter>
                                    </Modal>
                                </Col>
                            </Row>
