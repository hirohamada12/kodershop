...
import BG_Image from '../assets/images/categories/sub.jpeg';
                ...
                <Row className="justify-content-center">
                    <Col sm={10} lg={6} md={8}>
                        <div className="newsletter-wrapper newsletter-style-1 newsletter-design-4">
                            <h2 style={{color: '#FFF'}} className="newsletter-title">Đăng kí ngay hôm nay và nhận giảm
                                giá 25% cho đơn hàng đầu tiên!</h2>
                            <div className="newsletter">
                                <div className="section-field">
                                    <div className="field-widget clearfix">
                                        <form className="newsletter_form"
                                              onSubmit={this.onProfileFormSubmit.bind(this)}>
                                            <div className="input-area">
                                                <input type="email" className="placeholder newsletter-email"
                                                       value={this.state.fieldvalue.newsletter_email}
                                                       onChange={this.handleChange.bind(this, "newsletter_email")}
                                                       name="newsletter_email" placeholder="Nhập Email của bạn"/>
                                                <span className="error">{this.state.errors["newsletter_email"]}</span>
                                            </div>
                                            <div className="button-area">
                                    <span className="input-group-btn">
                                        <button type="submit" className="btn btn-icon">Đăng Kí</button>
                                    </span>
                                            </div>
