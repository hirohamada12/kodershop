                        ...
                        <div className="team shadow">
                            ...
                            <div className="team-info">
                                <div className="team-description">
                                    <h4>Võ Tá Nhật Anh</h4>
                                    <span>CTO</span>
                                </div>
                                <div
                                    className="team-social-icon ciyashop-social-icons ciyashop-social-shape-round ciyashop-social-effect-color-hover ciyashop-social-size-small">
                                    <ul>
