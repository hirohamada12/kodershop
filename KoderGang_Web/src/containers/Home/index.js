                                    ...
                                    <div className="entry-content">
                                                    ...
                                                    <Row mb={3} className="justify-content-center">
                                                        <Col sm={10} lg={6} className="text-center">
                                                            <div className="section-title">
                                                                <h2 className="title"> Hàng Bán Chạy</h2>
                                                                <p>Những sản phẩm tốt thường đem lại chất lượng tốt</p>
                                                            </div>
                                                        </Col>
                                                    </Row>
                                                    <TopSellingProduct/>
                                        ...
                                        <Container>
                                            <div className="row section-ptb">
                                                ...
                                                {/*        <div*/}
                                                {/*            className="col-sm-12 offset-lg-2 col-lg-8 offset-md-1 col-md-9">*/}
                                                {/*            <div className="section-title">*/}
                                                {/*                <h2 className="title"> Our Latest Post</h2>*/}
                                                {/*                <p>Read what we say on our blog. you do not have to*/}
                                                {/*                    worry about getting stuck alone trying to figure*/}
                                                {/*                    everything out.</p>*/}
                                                {/*            </div>*/}
                                                {/*        </div>*/}
                                                {/*    </div>*/}
